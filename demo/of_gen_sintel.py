...
def build_flow(model_name, ckpt_path, sequence, set_disp, factor):
    path_in_data = 'C:/Users/jcds/Documents/GitHub/xvoldor/demo/data/MPI-Sintel/training/final'
    path_out_data = 'C:/Users/jcds/Documents/GitHub/xvoldor/demo/data/MPI-Sintel/training'
    path_1 = os.path.join(path_in_data, f'{sequence}')
    flow_name = 'flow'
    path_out = os.path.join(path_out_data, f'{flow_name}_ptl-{model_name}/{sequence}', )
    path_out_vis = os.path.join(path_out_data, f'{flow_name}_vis_ptl-{model_name}/{sequence}')
...
if __name__ == '__main__':
    param_model_name = 'pwcnet' #'memflow'
    param_ckpt_path = 'sintel' #'spring'
    param_factor = 1
