...
// OK
template <typename T, int max_points = 16>
T compute_scale(T const* points_2D, T const* points_3D, int count, T* RT01)
{
    T scales[max_points];
    
    // TODO: count > max_points
    ...
    for (int i = 0; i < N; ++i)
    {
        ...
        T den2 = tR2_x * tR2_x + tR2_y * tR2_y + tR2_z * tR2_z;
        T rho = std::sqrt(num2 / den2);
